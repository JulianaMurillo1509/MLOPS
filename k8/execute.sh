...
docker tag leodocker2021/my-repo-mlops-api-inference   leodocker2021/my-repo-mlops-api-inference:latest
docker tag leodocker2021/my-repo-mlops-api-train   leodocker2021/my-repo-mlops-api-train:latest
...
if ! microk8s status --wait-ready --timeout 60s > /dev/null 2>&1; then
